...
public class _LocatorStub extends org.omg.CORBA.portable.ObjectImpl implements Locator
{
  ...
  /** locate server - returns all ports registered with a specified ORB for
  	...
  	* Starts the server if it is not already running.
  	*/
  public com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB locateServerForORB (String serverId, String orbId) throws InvalidORBid, com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, com.sun.corba.se.PortableActivationIDL.ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {

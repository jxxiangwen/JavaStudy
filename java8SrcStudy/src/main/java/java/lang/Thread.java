 ...
 * creating thread is a daemon.守护线程创建的新行程是守护线程
 * <p>
...
// 1.RunTime的exit方法执行并且权限正确
// 2.所有非守护线程都已死亡或者都从run方法返回了或者超出了run方法的异常抛出
// 以上情况出现虚拟机关闭运行
...
public class Thread implements Runnable {
    ...
    */
     ...
     */
    /*
     * 如果线程在调用wait(),join(),sleep(long)等方法会清楚中断status同时收到InterruptedException
     */
    /*
    * 如果线程阻塞在InterruptibleChannel上的I/O operation,则通道会关闭,设置中断status,
    * 同时收到一个ClosedByInterruptException
    * */
    /**
    ...
    */
     ...
     * @since 1.5
     */
    // 当当前线程没有uncaughtExceptionHandler时使用group的

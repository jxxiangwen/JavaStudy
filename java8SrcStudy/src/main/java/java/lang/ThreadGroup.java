...
// 线程组可以包含线程组,线程组有点像树形结构
// 线程可以访问自己所属的线程组信息,但是不允许访问其他线程组信息,包括其爷爷线程组
/**
...
public class ThreadGroup implements Thread.UncaughtExceptionHandler {
     ...
     * @since JDK1.0
     */
    // 必须要所有nthreads = 0 同时所有子线程组已经destroy
    ...
    void add(Thread t) {
        synchronized (this) {
            ...
            // decremented.
            // 调用线程的init方法会调用addUnstarted()增加nUnstartedThreads
            // 调用线程的start方法会调用本方法减少nUnstartedThreads
            // 如果Thread start失败,会调用threadStartFailed()nUnstartedThreads++
            nUnstartedThreads--;
        }
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        if (parent != null) {
            ...
            if (ueh != null) {
                ...
                // 其实就是最高层次的uncaughtException不会处理ThreadDeath异常
